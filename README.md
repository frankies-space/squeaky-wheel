...
| `POST` | `/checkin/today/replan` | Delete today's plan and re-propose (dev/tests) |
| `GET` | `/checkin/evening` | Start/load evening review for confirmed plan |
| `POST` | `/checkin/evening/complete` | Record done/partial/not_done + attention log |
...
Screens:
- **Today** — morning check-in chat (3 cards, Looks good / Adjust) + evening review chips after confirm
